...
class ComputePropellerWeight(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:propulsion:electric_powertrain:motor:nominal_power", units="W")
        self.add_input("data:geometry:propulsion:engine:count", val=np.nan, units=None)

        self.add_output("data:weight:propulsion:electric_powertrain:propeller:mass", units="lb")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        b7 = 31.92 * (num_blades ** 0.391) * (
                (prop_diameter * (max_power*0.00134102/num_eng)/1000) ** 0.782)

        outputs["data:weight:propulsion:electric_powertrain:propeller:mass"] = b7

...
from fastga.models.weight.mass_breakdown.c_systems.constants import SUBMODEL_POWER_SYSTEM_MASS


@oad.RegisterSubmodel(
    SUBMODEL_POWER_SYSTEM_MASS, "fastga.submodel.weight.mass.system.power_system.electric"
)
class ComputePowerSystemsWeight(ExplicitComponent):
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        c12 = 426.0 * ((m_iae) / 1000.0) ** 0.51  # mass formula in lb

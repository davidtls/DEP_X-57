...
from fastga.models.weight.constants import SUBMODEL_CENTER_OF_GRAVITY
...
@oad.RegisterSubmodel(SUBMODEL_CENTER_OF_GRAVITY, "fastga.submodel.weight.cg.electric_propulsion")
class CG(om.Group):

...
class ComputeEPUCG(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output("data:weight:propulsion:electric_powertrain:EPU:CG:x", units="m")

        self.declare_partials(
            "data:weight:propulsion:electric_powertrain:EPU:CG:x",
            [
                "*"
            ],
            method="fd",
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:weight:propulsion:electric_powertrain:EPU:CG:x"] = x_cg_b1

...
class ComputeBatteryCG(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output("data:weight:propulsion:electric_powertrain:battery:CG:x", units="m")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        # Single battery placed behind the pilot seat : 95% of the cabin
        cg_b6 = fus_front_length + 0.95 * cabin_length

        outputs["data:weight:propulsion:electric_powertrain:battery:CG:x"] = cg_b6

...
from fastga.models.weight.cg.cg_components.constants import SUBMODEL_LOADCASE_GROUND_X, SUBMODEL_LOADCASE_FLIGHT_X


@oad.RegisterSubmodel(
    SUBMODEL_LOADCASE_GROUND_X, "fastga.submodel.weight.cg.loadcase.ground.electric"
)
        ...
        for m_lug in m_lug_array:
            ...
            for m_pilot in m_pilot_array:
                ...
                for m_pax in m_pax_array:
                    mass = m_pax + m_pilot + m_lug + m_empty
                    cg = (
...
@oad.RegisterSubmodel(
    SUBMODEL_LOADCASE_FLIGHT_X, "fastga.submodel.weight.cg.loadcase.flight.electric"
)

...
from .constants import SUBMODEL_HT_AREA_PA, SUBMODEL_VT_AREA


@oad.RegisterOpenMDAOSystem(
    "fastga.handling_qualities.tail_sizing_PA", domain=ModelDomain.HANDLING_QUALITIES
)
class UpdateTailAreas(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "horizontal_tail",
            oad.RegisterSubmodel.get_submodel(SUBMODEL_HT_AREA_PA, options=propulsion_option),
            promotes=["*"],
        )
        self.add_subsystem(
            "vertical_tail",

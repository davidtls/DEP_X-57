...
class ComputeNacellePosition(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output("data:geometry:propeller:available_space_propellers", units="m")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:geometry:propeller:available_space_propellers"] = 0.118 * inputs["data:geometry:wing:span"] * 0.5 - inputs["data:geometry:propeller:diameter"]  # fixme for clearance between propellers
